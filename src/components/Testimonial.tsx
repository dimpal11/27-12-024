...
<section className="relative bg-gray-50 container max-w-screen-xl py-0 md:py-5 px-0 md:px-4 mx-auto overflow-x-hidden ">
  ...
  {/* Contact Us Section */}
  <section className="py-10  mx-auto container px-4 md:px-10 lg:px-16 bg-gray-50 pb-[100px]">
...
<section className="relative max-w-[90%] flex justify-center items-center mx-auto bottom-[100px] mt-[20px] mb-[20px]">
  <div className="container mx-auto px-4 bg-[#372011] p-6 shadow-lg">
    <div className="flex flex-wrap items-center">
      {/* Left Side: Image */}
      <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
        <Image src={foter} alt="logo" />
      </div>
